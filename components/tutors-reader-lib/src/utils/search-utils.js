 ...
 */
export function searchHits(los, searchTerm) {
    let flatLos = flattenNestedLosArrays(los);
    //let result : string[] = [];
    let results = [];
    flatLos.forEach((obj) => {
        let text = obj.lab.contentMd;
        let contents = arrayLinesSearchTermHits(text, searchTerm);
 ...
 */
function arrayLinesSearchTermHits(content, searchTerm) {
    let arStrings = [];
 ...
 */
function getLanguage(content, indexSearchTerm) {
 ...
 */
function getFenceType(content, indexSearchTerm) {
    let ar = arStartFenceIndices(content);
    let indexFence = findNearestPreviousIndex(ar, indexSearchTerm);
 ...
 * @return The path
 */
export function extractPath(astring) {
    let regex = /#/;
 ...
 * @param route
 */
export function findLo(route, los) {
    let flatLos = flattenNestedLosArrays(los);
    let lo;
    flatLos.forEach((obj) => {
 ...
 * @returns
 */
function flattenNestedLosArrays(los) {
    return flatten(los, "");
}
function flatten(arr, topicTitle, result = []) {
...
function indicesOf(str, substr) {
    let arIndx = [];
    function indicesOf(str, substr, arIndx) {
 ...
 */
function arStartFenceIndices(content) {
 ...
 */
function isFenced(content, searchTermIndex) {
 ...
 * @returns array of indices
 */
function arrayStartFenceIndices(content, fenceType) {
 ...
 */
function currentline(searchTerm, indexSearchTerm, content) {
 ...
 */
function findNearestPreviousIndex(indices, currIndex) {
 ...
 *
 */
function findNearestNextIndex(indices, currIndex, contentLen) {
