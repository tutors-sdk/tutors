...
<footer class="mx-auto w-11/12 py-8">
  <div class="flex grid-flow-col items-center">
    <div class="inline-flex flex-1">
      <svg width="40px" viewBox="0 0 54.5 39.4" xml:space="preserve"
        ...
        V4.5H50V34.8z"></path><g
            ><rect fill="#37919b" x="29" y="26.5" width="12.1" height="4.2"></rect><g
              ><path fill="#37919b" d="M13.4,13.5V8.7h19.1v4.8H26v17.2h-5.9V13.5H13.4z"></path></g
            ></g
          ></g
        ></svg
      >
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      class="btn mr-4 !rounded-md bg-[#435465] !py-2 !px-4"
    >
      <img
