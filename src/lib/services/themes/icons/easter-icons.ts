...
export const EasterIcons: IconLib = {
  ...
  // LoTypes icons
  course: { type: "mdi:easter", color: "primary" },
  topic: { type: "mdi:egg-easter", color: "secondary" },
  unit: { type: "mdi:rabbit-variant", color: "tertiary" },
  side: { type: "mdi:rabbit", color: "success" },
  ...
  panelnote: { type: "mdi:flower-tulip-outline", color: "warning" },
  ...
  lightMode: { type: "fxemoji:hatchingchick", color: "warning" },
  ...
  circular: { type: "mdi:easter-egg-outline", color: "warning" },
  ...
  calendar: { type: "mdi:calendar-outline", color: "bg-base-content" },
