<script lang="ts">
  ...
  import { Combobox, SegmentedControl } from "@skeletonlabs/skeleton-svelte";
...
{#snippet menuContent()}
  ...
  <div class="mt-5">
    ...
    <div class="mb-2 flex justify-center">
      <SegmentedControl name="lightMode" value={themeService.lightMode.value} onValueChange={(e) => themeService.setDisplayMode(e.value!)}>
    ...
    <div class="mb-2 flex justify-center">
      <SegmentedControl name="cardStyle" value={themeService.cardStyle.value} onValueChange={(e) => themeService.setCardStyle(e.value!)}>
    ...
    <div class="mb-2 flex justify-center">
      <SegmentedControl name="layout" value={themeService.layout.value} onValueChange={(e) => themeService.setLayout(e.value!)}>
