...
<div class="bg-surface-100-800-token mx-auto mb-2 place-items-center overflow-hidden rounded-xl p-4">
  <div class="flex flex-wrap justify-center">
    <div class="card w-4/5 !bg-surface-50 dark:!bg-surface-700 border-y-8 border-{getIcon('note').color}-500 m-2">
    ...
    <div class="card w-4/5 !bg-surface-50 dark:!bg-surface-700 border-y-8 border-{getIcon('topic').color}-500 m-2">
