...
describe("Tutors Reader: Loading the JSON fixture", function () {
   ...
   */
  describe('Course Reference Page Validation', function () {
  ...
  describe('Course Page Feature Tests', () => {
  ...
  describe('More in Depth Topic Tests', () => {
  ...
  describe('Verify that Archives do Download', () => {
