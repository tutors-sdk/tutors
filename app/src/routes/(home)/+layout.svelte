  ...
  <svelte:fragment slot="header">
    <NavigationPrimary>
      <svelte:fragment slot="lead">
        <a href="/">
          <DashboardTitle title="Tutors" subtitle="Tutors Open Source Project"></DashboardTitle>
        </a>
      </svelte:fragment>
      ...
      <footer class="mx-auto w-11/12 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-[auto_auto_auto_auto] gap-10">
            ...
            <div class="grid grid-cols-1 gap-2 place-content-center place-items-center md:place-items-start">
              <div>
                ...
                <p class="font-bold !text-lg mt-4">
                  ...
                  <a href="https://github.com/tutors-sdk/tutors/blob/main/LICENSE" target="_blank" class="link" rel="noreferrer">MIT License </a>
                </p>
              </div>
            </div>
          </div>
          <div class="space-y-4">
            ...
            <ul class="space-y-2">
              <li>
                <a href="https://github.com/tutors-sdk/tutors" target="_blank" rel="noreferrer">View GitHub</a>
              </li>
              <li>
                <a href="https://discord.tutors.dev" target="_blank" rel="noreferrer">Join Discord Community</a>
              </li>
              <li>
                <a rel="noreferrer" href="https://fosstodon.org/@tutors" target="_blank">Follow on Mastodon</a>
              </li>
              <li>
                <a href="https://twitter.com/tutors_dev" target="_blank" rel="noreferrer">Follow on Twitter</a>
              </li>
            </ul>
          </div>
          <div class="space-y-4">
            ...
            <ul class="space-y-2">
              <li>
                <a href="https://tutors.dev/course/tutors-docs" target="_blank" rel="noreferrer">Documentation</a>
              </li>
              <li>
                <a href="https://github.com/tutors-sdk/tutors/blob/main/CODE_OF_CONDUCT.md" target="_blank" rel="noreferrer">Code of Conduct</a>
              </li>
            </ul>
          </div>
          <div class="space-y-4">
            ...
            <ul class="space-y-2">
              ...
              <li>
                <a href="https://setu.ie" target="_blank" class="btn !rounded-md bg-[#435465] !py-2 !px-4" rel="noreferrer">
