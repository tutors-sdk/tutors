<script lang="ts">
	...
	import { semanticNames, tailwindDefaultColors } from './colors';
    import {
		storeMode,
		storePreview,
		storeTailwindForm,
    ...
    import {Alert, RadioGroup, RadioItem, LightSwitch, SlideToggle, CodeBlock } from '@skeletonlabs/skeleton';
...
:root {
    ...
    if ($storePreview) {
    document.body.setAttribute("data-theme", themeCSS);
    } else {
    document.body.setAttribute("data-theme", 'tutors');
    }
