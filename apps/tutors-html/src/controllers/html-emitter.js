...
class HtmlEmitter {
    ...
    emitObjectves(lo) {
        ...
        // @ts-ignore
        if (((_a = lo === null || lo === void 0 ? void 0 : lo.objectivesMd) === null || _a === void 0 ? void 0 : _a.length) > 60) {
            lo.objectivesMd = (_b = lo === null || lo === void 0 ? void 0 : lo.objectivesMd) === null || _b === void 0 ? void 0 : _b.substring(0, 60);
            lo.objectivesMd = (_c = lo === null || lo === void 0 ? void 0 : lo.objectivesMd) === null || _c === void 0 ? void 0 : _c.concat('...');
        }
        if (lo.objectivesMd)
    ...
    emitTopic(topic, path) {
        ...
        topic.standardLos = (0, loutils_1.sortLos)(topic.standardLos);
