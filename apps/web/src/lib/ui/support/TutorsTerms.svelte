<script lang="ts">
	import { authenticating } from '$lib/stores';
...
<div class="flex min-h-screen items-center justify-center overflow-auto bg-surface-600">
	<div class="card m-8 flex w-11/12 flex-wrap justify-items-center p-4 shadow-xl lg:w-2/3">
		...
		<div class="font-sm text-l p-2 text-left font-light">
			<p class="p-2">
				You have been authenticated via your GitHub credentials and are about to enter a Tutors
				course. Tutors will record how much time each view is active and send this to the TutorsTime
				data store. You can view this information via the TutorsTime feature on the course
				Navigator.<br /><br />
		...
		<button class="btn bg-primary-500 text-white" on:click={acceptAuthenticate}
			>Proceed to Course
		</button>
	</div>
</div>
